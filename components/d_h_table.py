...
class DHTable:
    def __init__(self, parent, cb):
        ...
        self.table_header = ttk.Label(self.btn_frame, text='D-H Parameters', font='bold')
        self.table_header.pack(padx=(50, 5), pady=10)
        ...
        self.frame.pack(fill='x', padx=50, pady=10)

        self.rows = []
        new_row = TableRow(self.frame, 'Joint_1')
    ...
    def add_row(self):
        ...
        if current_row >= 6:
            ...
            return 
        new_row = TableRow(self.frame, f'Joint_{current_row + 1}')
        self.rows.append(new_row)
